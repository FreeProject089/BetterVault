const CACHE_NAME = 'bettervault-v7';
...
self.addEventListener('fetch', (event) => {
  ...
  const serverRendered = url.pathname === '/' || ['/legal', '/admin', '/docs', '/about', '/serveurs', '/tarifs', '/telecharger', '/download', '/site.js', '/auth', '/connexion', '/security'].some(
