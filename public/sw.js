const CACHE_NAME = 'bettervault-v8';
...
self.addEventListener('fetch', (event) => {
  ...
  const serverRendered = url.pathname === '/' || ['/legal', '/admin', '/docs', '/about', '/servers', '/pricing', '/download', '/theme', '/serveurs', '/tarifs', '/telecharger', '/site.js', '/auth', '/connexion', '/security'].some(
