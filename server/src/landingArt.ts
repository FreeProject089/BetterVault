...
export function snakeSteps(steps: SnakeStep[], stepLabel: string): string {
  ...
  m += ` L50,${H}`;
  // Une seule teinte (l'accent), éclaircie à mi-parcours, qui s'efface au bout ; les étapes gardent leur couleur
  const stops = '<stop offset="0" stop-color="#b8b6fb"/><stop offset="0.3" stop-color="#7773e8"/><stop offset="0.55" stop-color="#b8b6fb"/><stop offset="0.85" stop-color="#7773e8"/><stop offset="1" stop-color="#7773e8" stop-opacity="0"/>';
...
.snake-wide path{stroke-width:22px;transition:stroke-dashoffset .15s linear}
