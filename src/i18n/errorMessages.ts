...
const EXACT: Record<string, string> = {
  ...
  'Texte chiffré Bitwarden non reconnu': 'Unrecognised Bitwarden encrypted text',
  'Mot de passe requis': 'Password required',
  'Seule la dérivation PBKDF2 est prise en charge': 'Only PBKDF2 key derivation is supported',
  'Nombre d’itérations PBKDF2 invalide': 'Invalid PBKDF2 iteration count',
